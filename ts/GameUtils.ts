...
export class Storage {
     ...
     */
    static save(key: string, value: string | number): boolean {
        try {
...
export class DrawUtils {
     ...
     */
    static clearCell(ctx: CanvasRenderingContext2D, col: number, row: number, blockSize: number): void {
    ...
    static drawButton(
        ...
        text: string,
        fontSize: number,
        fontFamily: string = "'Press Start 2P', monospace"
    ) {
        // Button background
